...
export function ScenarioEditor() {
  ...
  /**
   * Один шаг назад, а не полная история: и «Развернуть черновик», и
   * «Заполнить критерии» заменяют часть формы целиком, и оба используют один
   * и тот же снимок — только последняя генерация обратима.
   */
