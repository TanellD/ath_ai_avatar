...
from ath_contracts import Action, OpeningKind
from ath_contracts.api import CharacterReplyDone, CharacterReplyRequest
...
async def character_reply(payload: CharacterReplyRequest, request: Request):
    ...
    async def event_stream() -> AsyncIterator[dict[str, str]]:
        ...
        done = CharacterReplyDone(action=Action.STAY, full_text="".join(parts))
