...
прошёл автоматические проверки и ручную проверку в браузере. Добавлены базовые
метрики и fault-тесты lifecycle. GigaAM/failover и hands-free ещё не реализованы. Это единственный актуальный
